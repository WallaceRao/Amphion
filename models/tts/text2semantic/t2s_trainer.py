...
from models.tts.text2semantic.t2s_emilia_dataset import T2SDataset, T2SCollator

import safetensors



class T2STrainer(TTSTrainer):
    ...
    def _build_model(self):
        model = T2SLlama(cfg=self.cfg.model.t2sllama)
        return model
